...
class IMU():
    ...
    def __init__(self, **kwargs):
        ...
        # gpio_interrupt_pin
        self.gpio_interrupt_pin = kwargs.pop('gpio_interrupt_pin', defaults['gpio_interrupt_pin'])

        # i2c_bus
        self.i2c_bus = kwargs.pop('i2c_bus', defaults['i2c_bus'])
        
        # i2c_addr
        self.i2c_addr = kwargs.pop('i2c_addr', defaults['i2c_addr'])
        ...
        initialize(gpio_interrupt_pin = self.gpio_interrupt_pin,
                   i2c_bus = self.i2c_bus,
                   i2c_addr = self.i2c_addr,
                   accel_fsr = self.accel_fsr,
    ...
    def set(self, **kwargs):
        ...
        # gpio_interrupt_pin
        if 'gpio_interrupt_pin' in kwargs:
            self.gpio_interrupt_pin = kwargs.pop('gpio_interrupt_pin')
            
        # i2c_bus
        if 'i2c_bus' in kwargs:
            self.i2c_bus = kwargs.pop('i2c_bus')

        # i2c_addr
        if 'i2c_addr' in kwargs:
            self.i2c_addr = kwargs.pop('i2c_addr')
